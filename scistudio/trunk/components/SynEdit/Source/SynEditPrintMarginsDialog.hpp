...
// (DO NOT EDIT: machine generated header) 'SynEditPrintMarginsDialog.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TSynEditPrintMarginsDlg(Classes::TComponent* AOwner
		) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TSynEditPrintMarginsDlg(Classes::TComponent* 
...
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TSynEditPrintMarginsDlg(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
