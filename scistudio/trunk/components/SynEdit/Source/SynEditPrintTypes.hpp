...
// (DO NOT EDIT: machine generated header) 'SynEditPrintTypes.pas' rev: 5.00
...
typedef void __fastcall (__closure *TPrintStatusEvent)(System::TObject* Sender, TSynPrintStatus Status
...
extern PACKAGE bool __fastcall WrapText(const AnsiString Line, const TSysCharSet &BreakChars, int MaxCol
	, Classes::TList* AList);
