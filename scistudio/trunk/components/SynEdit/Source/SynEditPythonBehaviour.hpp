...
// (DO NOT EDIT: machine generated header) 'SynEditPythonBehaviour.pas' rev: 5.00
...
protected:
	...
	virtual void __fastcall doProcessUserCommand(System::TObject* Sender, Syneditkeycmds::TSynEditorCommand 
