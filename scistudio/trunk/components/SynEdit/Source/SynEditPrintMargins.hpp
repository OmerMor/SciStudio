...
// (DO NOT EDIT: machine generated header) 'SynEditPrintMargins.pas' rev: 5.00
...
public:
	...
	void __fastcall InitPage(Graphics::TCanvas* ACanvas, int PageNum, Syneditprinterinfo::TSynEditPrinterInfo* 
		PrinterInfo, bool LineNumbers, bool LineNumbersInMargin, int MaxLineNum);
