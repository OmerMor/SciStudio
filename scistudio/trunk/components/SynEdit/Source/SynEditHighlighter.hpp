...
// (DO NOT EDIT: machine generated header) 'SynEditHighlighter.pas' rev: 5.00
...
__published:
	__property Graphics::TColor Background = {read=fBackground, write=SetBackground, stored=GetBackgroundColorStored
		, nodefault};
	__property Graphics::TColor Foreground = {read=fForeground, write=SetForeground, stored=GetForegroundColorStored
		, nodefault};
...
public:
	#pragma option push -w-inl
	/* virtual class method */ virtual TSynHighlighterCapabilities __fastcall GetCapabilities() { return 
		GetCapabilities(__classid(TSynCustomHighlighter)); }
	#pragma option pop
	/*         class method */ static TSynHighlighterCapabilities __fastcall GetCapabilities(TMetaClass* vmt
		);
	#pragma option push -w-inl
	/* virtual class method */ virtual AnsiString __fastcall GetLanguageName() { return GetLanguageName(__classid(TSynCustomHighlighter)
		); }
	#pragma option pop
