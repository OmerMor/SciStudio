...
// (DO NOT EDIT: machine generated header) 'SynEditExport.pas' rev: 5.00
...
protected:
	...
	virtual void __fastcall FormatAttributeDone(bool BackgroundChanged, bool ForegroundChanged, Graphics::TFontStyles 
		FontStylesChanged) = 0 ;
	virtual void __fastcall FormatAttributeInit(bool BackgroundChanged, bool ForegroundChanged, Graphics::TFontStyles 
		FontStylesChanged) = 0 ;
	virtual void __fastcall FormatAfterLastAttribute(void) = 0 ;
	virtual void __fastcall FormatBeforeFirstAttribute(bool BackgroundChanged, bool ForegroundChanged, 
		Graphics::TFontStyles FontStylesChanged) = 0 ;
	...
	virtual void __fastcall SetTokenAttribute(bool IsSpace, Synedithighlighter::TSynHighlighterAttributes* 
		Attri);
...
public:
	...
	void __fastcall ExportRange(Classes::TStrings* ALines, const Windows::TPoint &Start, const Windows::TPoint 
		&Stop);
