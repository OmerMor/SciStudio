...
// (DO NOT EDIT: machine generated header) 'SynHighlighterNHA.pas' rev: 5.00

#ifndef SynHighlighterNHAHPP
#define SynHighlighterNHAHPP
...
namespace Synhighlighternha
{
//-- type declarations -------------------------------------------------------
#pragma option push -b-
enum TtkTokenKind { tkComment, tkKey, tkNull, tkNumber, tkSpace, tkString, tkOperator, tkOptions, tkPrep, 
	tkError, tkUnknown };
#pragma option pop
...
class DELPHICLASS TSynNHASyn;
class PASCALIMPLEMENTATION TSynNHASyn : public Synedithighlighter::TSynCustomHighlighter 
{
...
private:
	...
	Synedithighlighter::TSynHighlighterAttributes* fPrepAttri;
...
public:
	__fastcall virtual TSynNHASyn(Classes::TComponent* AOwner);
...
__published:
	...
	__property Synedithighlighter::TSynHighlighterAttributes* PrepAttri = {read=fPrepAttri, write=fPrepAttri
		};
	__property Synedithighlighter::TSynHighlighterAttributes* OptionsAttri = {read=fOptionsAttri, write=
		fOptionsAttri};
...
public:
	...
	/* TSynCustomHighlighter.Destroy */ inline __fastcall virtual ~TSynNHASyn(void) { }
	#pragma option pop
...
using namespace Synhighlighternha;
#endif
#pragma option pop	// -w-
