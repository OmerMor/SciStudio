...
// (DO NOT EDIT: machine generated header) 'SynEditPrintHeaderFooter.pas' rev: 5.00
...
public:
	...
	AnsiString __fastcall GetText(int NumPages, int PageNum, bool Roman, AnsiString Title, AnsiString ATime
		, AnsiString ADate);
...
public:
	...
	void __fastcall InitPrint(Graphics::TCanvas* ACanvas, int NumPages, AnsiString Title, Syneditprintmargins::TSynEditPrintMargins* 
		Margins);
